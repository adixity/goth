# Goth: Multi-Provider Authentication for Go [![GoDoc](https://godoc.org/github.com/adixity/goth?status.svg)](https://godoc.org/github.com/adixity/goth) [![Build Status](https://travis-ci.org/markbates/goth.svg)](https://travis-ci.org/markbates/goth) [![Go Report Card](https://goreportcard.com/badge/github.com/adixity/goth)](https://goreportcard.com/report/github.com/adixity/goth)
...
```text
$ go get github.com/adixity/goth
```
